...
myButton1.onclick = function lol() {
    ...
    if((c1%2 ==0 || c2%2 ==0 || c3%2 ==0 || c4%2 ==0 || c5%2 ==0 || c6%2 !=0) && c7%2!=0){
        mydiv7.classList.toggle("onflashmain");
        c7++;
    }
};
...
/*Turn on and off light 5*/
var mydiv6 = document.getElementById("flash6"),
	myButton6 = document.getElementById("btn6");
myButton6.onclick = function lol() {
	"use strict";
    mydiv6.classList.toggle("onflash");
    c6++;
    if(c1%2 !=0 && c2%2 !=0 && c3%2 !=0 && c4%2 !=0 && c5%2 !=0 && c6%2 !=0){
        mydiv7.classList.toggle("onflashmain");
        c7++;
